  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      context: {
        ...
        pageName: "Playbook for Technical Content Marketing",
      },
    };
            ...
            <div className="max-w-md space-y-6">
              <div className="space-y-10">
                <h1 className="text-4xl font-bold text-white leading-normal tracking-tight">
                  Developer Marketing Playbook for DevTool and AI Agents Startups in 2025{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-600">
                    Build Developer Trust & Drive Adoption
                  </span>
                </h1>
              </div>
              <div className="space-y-10 text-gray-300 text-[19px] leading-relaxed tracking-wide">
                <p>
                  Developer marketing is no longer optional - it's essential for DevTools and SaaS startups. 
                  Learn how we turn developer trust into product adoption, community growth, and technical authority.
                  If you're still using traditional marketing, you're missing the developers who drive 60% of B2B tech decisions.
                </p>
              </div>
            </div>
          </div>
