    ...
    >
      ...
      <ul className="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-4">
        ...
        <li className="flex flex-col gap-2 text-sm text-zinc-400">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" strokeLinecap="round" stroke-linejoin="round" class="lucide lucide-timer stroke-1 mb-2 text-current w-7 h-7"><line x1="10" x2="14" y1="2" y2="2"></line><line x1="12" x2="15" y1="14" y2="11"></line><circle cx="12" cy="14" r="8"></circle></svg>
        ...
        {/* Item 2 */}
        <li className="flex flex-col gap-2 text-sm text-zinc-400">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="stroke-1 mb-2 text-current w-7 h-7"><path strokeLinecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
          <div className="w-full h-px bg-zinc-700">
            <span className="block w-7 h-px bg-zinc-400" />
          </div>
          <h4 className="text-lg lg:text-xl mt-1 text-zinc-100">
        ...
        {/* Item 4 */}
        <li className="flex flex-col gap-2 text-sm text-zinc-400">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" strokeLinecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right stroke-1 mb-2 text-current w-7 h-7"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
          <div className="w-full h-px bg-zinc-700">
            <span className="block w-7 h-px bg-zinc-400" />
          </div>
          <h4 className="text-lg lg:text-xl mt-1 text-zinc-100">
