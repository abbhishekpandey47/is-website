    ...
    >
      ...
      >
        <div className="h-[80%] max-lg:h-full flex flex-col justify-center gap-5 max-lg:gap-2">
          ...
          <div>
            <h2
              className="quicksand-bold text-[3em] max-lg:text-[2em] leading-[45px] max-md:text-center"
              dangerouslySetInnerHTML={{ __html: data.hTag }}
            ></h2>
          </div>
          <div>
            <p className="quicksand-medium max-lg:text-[0.8em] max-md:text-[1.2em] max-md:text-center">
              {data.pTag}
            </p>
          </div>
        </div>
