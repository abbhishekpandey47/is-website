...
const Hero = () => {
  return (
    <section className="bg-[#121826] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-28 flex flex-col items-center text-center">
        ...
        <p className="mt-4 text-lg sm:text-xl text-gray-300 max-w-[700px]">
        ...
        <form className="mt-8 flex flex-col sm:flex-row items-center w-full sm:w-auto">
          <input
            ...
            required
            className="w-full sm:w-[324px] px-4 py-3 rounded-xl bg-[#1A1F2E] text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 sm:mr-3"
          />
          <button
            type="submit"
            className="mt-3 sm:mt-0 px-6 py-3 rounded-xl font-medium text-white bg-gradient-to-r from-blue-500 to-indigo-500 hover:opacity-90 transition"
          >
            Start in 30 seconds
          </button>
        </form>
