...
const BlogTypes = () => {
  ...
  return (
    <section className="w-full py-20 px-6 md:px-10 whyinfra3 ">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {visibleBlogTypes.map((blogType) => (
              <div key={blogType.id} className="relative glassEffect">
                <div className=" p-6">
          ...
          <div className="flex justify-center mt-12">
            <Button
              variant="outline"
              className="border-[#5F64FF] py-6 px-4 bg- font-medium text-md text-white"
