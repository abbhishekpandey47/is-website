  ...
  return (
    <section className="w-full h-[100vh] flex flex-col items-center justify-center bg-transparent pt-24 px-8">
      ...
      <div className="relative w-full h-[100vh] rounded-3xl shadow-2xl overflow-hidden border">
        ...
        />
        {/* Content above image */}
        <div className="relative z-10 max-w-3xl mx-auto text-center py-8 px-4 mt-4">
          ...
          <Link href="/contact">
            <button className="mt-4 px-4 py-2 rounded-xl bg-[#6F74FF] text-white font-semibold text-base shadow-lg hover:bg-[#473b79] transition">Book a Call</button>
          </Link>
        </div>
      </div>
    </section>
