export default function SecondSection() {
	...
	const cards = [
		...
		{
			title: "Intent understanding > keyword matching",
			text: "Search has moved beyond keywords. Users ask questions and expect full, accurate answers. GEO creates authoritative, semantically rich content that AI trusts and surfaces.",
			img: "/aeo/3.svg",
			className: "md:col-span-6",
		},
		{
			title: "Rise of personalized search",
			text: "AI understands the who, where, and why behind every search. It tailors results by behavior, location, and context, making visibility hyper-contextual.",
			img: "/aeo/4.svg",
			className: "md:col-span-6",
		},
		{
			title: "AI as a knowledge partner",
			text: "From product discovery to research, users trust AI to simplify complexity. If your content isn't optimized for the same, you're lagging behind.",
			img: "/aeo/5.svg",
			className: "md:col-span-3",
		},
		{
			title: "Multimodal is the new default",
			text: "AI results aren't just text anymore. They're visual, vocal, and interactive. This means your brand must optimize across formats, not just for Google snippets.",
			img: "/aeo/6.svg",
			className: "md:col-span-3",
		},
	];
	...
	return (
		<section className="relative w-full py-20 px-4 overflow-hidden">
			...
			<div className="max-w-5xl mx-auto text-center mb-14">
				<h2 className="text-2xl md:text-4xl font-semibold text-white mb-4 whitespace-nowrap" style={{ fontFamily: "Manrope, sans-serif" }}>
						...
						>
							<div className="relative z-10 p-6 md:p-7">
								<div className="rounded-2xl border border-zinc-700/80 overflow-hidden mb-5">
									<img src={card.img} alt={card.title} className="w-full h-[190px] object-cover" />
								</div>
