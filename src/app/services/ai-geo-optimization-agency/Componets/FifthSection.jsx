...
const metrics = [
  {
    title: 'AI Search Visibility Scores',
    description:
      'See how often your pages appear in AI-generated results across chatbots, AI overviews, and answer engines',
    visual: '/aeo/5.1.svg',
    kicker: 'Visibility Signals',
  ...
  {
    title: 'Referral Traffic From LLMs',
    description:
      'Track visits originating from tools like ChatGPT or Perplexity and identify which AI channel drives the most qualified traffic',
    visual: '/aeo/5.3.svg',
  ...
  },
  {
    ...
    description:
      'Analyze the tone and framing of your brand inside AI answers. Spot praise, address concerns, and see how AI talks about you',
    visual: '/aeo/5.4.svg',
  ...
  },
  {
    ...
    visual: '/aeo/5.5.svg',
    kicker: 'Community Influence',
    colSpan: 'md:col-span-4',
  },
  {
    title: 'Conversion Rates From AI Referrals',
    description:
      'Calculate the percentage of AI-driven visitors who complete goals once they land on your website',
    visual: '/aeo/5.6.svg',
    kicker: 'Revenue Impact',
    colSpan: 'md:col-span-6',
  },
  {
    title: 'Share of Voice',
    description:
      'Compare your AI mention share (share‑of‑voice) against competitors. See which gaps can be used to uncover new content opportunities',
    visual: '/aeo/5.7.svg',
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-12 gap-4">
          {metrics.map((metric, index) => (
            <article
              key={metric.title}
              className={`relative overflow-hidden rounded-3xl border border-white/15 bg-slate-950/95 shadow-[0_10px_40px_rgba(0,0,0,0.45)] ${metric.colSpan ?? 'md:col-span-3'}`}
              style={{
                backgroundImage: index === 2 || index === 5 || index === 6 ? cardBgSvgWide : cardBgSvg,
