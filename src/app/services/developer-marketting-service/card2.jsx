...
const DarkPipedreamDiagram = () => {
  return (
    <div className="flex items-center justify-center bg-black text-white py-10">
      <style>{`
        .dashed-line {
      ...
      <div className="flex items-center relative">
        ...
        <svg className="w-32 h-20" viewBox="0 0 115 80" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(0 39.95)">
            <path className="dashed-line" d="M 0 0 L 115 0" fill="transparent" stroke="rgb(255, 255, 255)" strokeDasharray="9.2 9.2" strokeLinecap="butt" strokeWidth="1" />
          </g>
        </svg>
        ...
        {/* Green connecting lines - positioned to connect directly to icons */}
        <div className="relative">
          <svg className="w-24 h-32 absolute -top-16" viewBox="0 0 96 128" xmlns="http://www.w3.org/2000/svg">
            {/* Top line to GitHub */}
            <path 
              d="M 0 64 L 40 64 C 55 64 65 54 65 39 L 65 10 C 65 5 70 0 75 0 L 96 0" 
              fill="transparent" 
              stroke="rgb(57, 209, 140)" 
              strokeWidth="2"
            />
            {/* Middle line to Salesforce */}
            <path 
              d="M 0 64 L 96 64" 
              fill="transparent" 
              stroke="rgb(57, 209, 140)" 
              strokeWidth="2"
            />
            {/* Bottom line to OpenAI */}
            <path 
              d="M 0 64 L 40 64 C 55 64 65 74 65 89 L 65 118 C 65 123 70 128 75 128 L 96 128" 
              fill="transparent" 
              stroke="rgb(57, 209, 140)" 
              strokeWidth="2"
            />
        ...
        {/* Service icons - positioned to align with green lines */}
        <div className="flex flex-col space-y-4 ml-6">
          {/* GitHub */}
          <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-lg p-3">
          ...
          {/* Salesforce */}
          <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-lg p-3">
            <img src="https://framerusercontent.com/images/fOGS30H04nLKlVAy0oNDZKH6o.png" alt="Salesforce" className="w-6 h-6" />
          </div>
