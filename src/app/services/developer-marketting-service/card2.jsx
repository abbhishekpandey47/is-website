      ...
      <div className="flex items-center relative">
        ...
        <div className="relative bg-green-500 rounded-md p-4">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-green-500 bg-gray-900 rounded-xl p-2">
            <img src="https://framerusercontent.com/images/aK147q8AJhR3d5mWPItWBOzAuog.png" alt="Pipedream" className="w-10 h-14" />
          </div>
        </div>

        <svg className="w-32 h-48" viewBox="0 0 102.5 183" xmlns="http://www.w3.org/2000/svg">
          <g>
        ...
        <div className="flex flex-col space-y-4">
          ...
          {/* Slack */}
          <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-lg p-2">
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none">
              <g clip-path="url(#a)">
