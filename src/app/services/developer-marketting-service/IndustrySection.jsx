...
const IndustrySection = () => {
  ...
  return (
    ...
    <div className="mx-[12px] lg:mx-0 relative">
        <div className="items-center gap-[16px]">
          <div className="flex flex-wrap justify-center gap-[16px] mt-[24px] lg:mt-[40px] max-w-[1400px] mx-auto">
        <Link href="/industries/financial-services" className="flex">
              <div className="group flex relative w-full rounded-[20px] md:w-[338px] h-[243px] px-[32px] py-[35px] justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Financial Services</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Helping you accelerate innovations and bring new experiences to banking, payment operations and FinTech.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                ...
                <div className="pointer-events-none absolute inset-[1px] z-20 rounded-[20px] opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100" style={{ opacity: 0.8, background: 'radial-gradient(200px at -200px -200px, rgb(38, 38, 38), transparent 100%)' }}></div>
                <div className="pointer-events-none absolute inset-0 rounded-[20px] transition-all duration-300 ease-in-out group-hover:opacity-100 bg-[#01041A]" style={{ background: 'radial-gradient(200px at -200px -200px, rgb(24, 106, 255), rgb(0, 88, 254), rgb(41, 48, 75) 100%)' }}></div>
              </div>
            </Link>
            <Link href="/industries/insurance" className="flex">
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Insurance</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Protect lives, properties and businesses, by bringing excellence through tech innovations and governance.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
            ...
            <Link href="/industries/healthcare" className="flex">
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="22" height="21" viewBox="0 0 22 21" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Healthcare</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Enhance patient care and operational efficiency in hospitals and clinics with secure health-tech solutions.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
            ...
            <Link href="/industries/travel" className="flex">
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Travel</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Reimagine travel experiences from booking to destination with cutting-edge, customer-focused solutions.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
            ...
            <Link href="/industries/automotive" className={`flex ${showAll ? '' : 'hidden'}`}>
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="22" height="15" viewBox="0 0 22 15" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Automotive</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Drive the future of mobility by combining AI innovation, robust API security, and API governance solutions.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
            ...
            <Link href="/industries/iot" className={`flex ${showAll ? '' : 'hidden'}`}>
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">IoT</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Innovate at the speed of connectivity with the power of API Intelligence and advanced API forensics.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
            ...
            <Link href="/industries/sports-tech" className={`flex ${showAll ? '' : 'hidden'}`}>
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Sports-Tech</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Lead the field with transformative sports-tech solutions that keep users engaged and experiences elevated.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
            ...
            <Link href="/industries/telecommunications" className={`flex ${showAll ? '' : 'hidden'}`}>
              <div className="group flex relative w-full rounded-[20px] w-full md:w-[338px] h-[243px] px-[32px] py-[35px]  justify-center cursor-pointer">
                <div className="absolute inset-[1px] z-10 rounded-[19px] bg-[#01041A]"></div>
                <div className="relative z-30">
                  <svg width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg" className="text-gray-400">
                  ...
                  <h3 className="font-poppins text-white text-[22px] mt-[8px]">Telecommunications</h3>
                  <p className="font-inter text-gray-400 mb-[16px]">Elevate global connections with secure, scalable platforms that make staying in touch simpler than ever.</p>
                  <span className="block text-gray-500 max-h-[24px] md:max-h-0 opacity-100 md:opacity-0 h-full items-center transition-[max-height_0.2s_ease,opacity_0.2s_ease] group-hover:opacity-100 group-hover:max-h-[24px]">
                    Learn more
                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" className="inline ml-[4px]">
                      <path d="M1.595 7.673c0 .352.285.636.637.636l9.434.015-2.734 2.728a.634.634 0 0 0 .45 1.085.636.636 0 0 0 .45-.186l3.822-3.814a.634.634 0 0 0 0-.898L9.833 3.425a.637.637 0 0 0-.9.899l2.733 2.728-9.434-.014a.636.636 0 0 0-.637.635z" fill="currentColor" fillRule="nonzero"></path>
