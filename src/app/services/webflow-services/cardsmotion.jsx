...
//       <div ref={containerRef} className="overflow-hidden max-w-8xl mx-auto touch-pan-x">
//         <motion.div
...
//                   className="w-full h-full object-cover md:rounded-r-xl sm:rounded-t-xl "
//                   width={600}
//                   height={550}
//                 />
//               </div>
        ...
        >
          {serviceArr.map((service, index) => (
            ...
            >
              ...
              {/* Image Section */}
              {/* <div className="w-screen md:w-1/2 h-[250px] md:h-full flex-shrink-0 "
