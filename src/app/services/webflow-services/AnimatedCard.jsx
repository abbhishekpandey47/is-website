...
//       {/* Auto scroll on desktop, manual scroll on mobile */}
...
//             <div
//               key={i}
//               className="bg-gradient-to-br from-[#231442] to-[#331a63] rounded-xl shadow-md p-3 w-[260px] sm:w-[320px] md:w-[400px] flex-shrink-0 flex flex-col relative"
//               style={{
//                 background: `linear-gradient(35deg, rgba(71, 24, 99, 0.2) 10%, rgba(118, 67, 175, 0.5) 50%, rgba(193, 145, 231, 0.2) 100%)`,
//                 boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.36)",
//               }}
...
//               {/* Title */}
//               <h3 className="text-lg sm:text-xl font-semibold mb-4 text-white text-start">
//                 {project.title}
//               </h3>
...
//                   <span
//                     key={idx}
//                     className="text-xs sm:text-sm font-medium px-2 py-1 rounded-full border bg-[#371577] text-white"
//                   >
//                     {badge}
//                   </span>
//                 ))}
...
//               {/* Project Image */}
//               <div className="rounded-lg overflow-hidden w-full h-[700px] sm:h-[260px] md:h-[350px]">
//                 <Image
//                   src={project.image}
//                   alt={`${project.title} - screenshot`}
