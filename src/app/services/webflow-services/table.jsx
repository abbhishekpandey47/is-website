        ...
        <div className="w-full overflow-x-auto scrollbar-hide">
          <div className="min-w-[800px] grid grid-cols-4 gap-4 md:gap-8 text-start">
            ...
            <div className="flex flex-col gap-4 md:gap-6 text-center p-2 md:p-2 rounded-lg justify-start">
              <div className="border-b border-solid border-gray-300 w-full pb-8 flex items-center justify-center">
            ...
            {/* Middle Column */}
            <div className="flex flex-col gap-4 md:gap-6 text-center p-2 md:p-2 justify-start w-full bg-[#23233b] rounded-lg">
              <div className="border-b border-solid border-gray-300 w-full pb-1 flex items-center justify-center">
                <Image
                  src={logo}
                  width={130}
                  height={40}
            ...
            {/* Right Column */}
            <div className="flex flex-col gap-4 md:gap-6 text-center p-2 md:p-2 rounded-lg justify-start">
              <div className="border-b border-solid border-gray-300 w-full pb-3 flex items-center justify-center">
