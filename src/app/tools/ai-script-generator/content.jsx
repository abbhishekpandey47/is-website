  ...
  return (
    <div className="text-white p-8">
      <div className="max-w-6xl mx-auto">
        <div className="bg-transparent border border-white/20 rounded-3xl py-12 px-8">
          {/* Header */}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Left Column */}
            <p className="text-lg font-[quicksand] leading-relaxed rounded-xl text-gray-300 border border-white/15 hover:border-white/30 p-4">
