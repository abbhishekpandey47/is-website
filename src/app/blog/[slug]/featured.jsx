...
const Featured = () => {
  ...
  return (
    <nav
      ...
      className={`w-[18rem] lg:w-[15rem] max-xl:w-[13rem] min-[2173px]:w-[22rem] min-[2173px]:text-lg min-[2500px]:w-[30rem] min-[2500px]:text-xl max-lg:w-[20rem] flex flex-col quicksand-light text-sm lg:mt-44 lg:ml-44 ${
        isSticky && "sticky"
