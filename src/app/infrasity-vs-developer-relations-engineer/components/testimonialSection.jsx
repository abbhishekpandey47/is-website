...
const TestiCard = ({
  ...
  return (
    <div className="max-md:w-[350px] h-[55vh] max-lg:h-[40vh] transition card bg-[#2a2d5a]/30 w-[30%] shadow-xl border border-purple-500/30 backdrop-blur-sm rounded-2xl p-6  flex flex-col overflow-x-hidden">
    ...
    <div>
      <div className="relative addGrid2">
        ...
        <div className="flex justify-center text-white testiMonialsHead">
          <h3 className="text-center text-[1.7em] w-[70%] quicksand-bold max-lg:text-[1.2em] max-sm:text-[.9em] max-sm:w-[95%] pt-3">
