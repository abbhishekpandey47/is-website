...
export default function PostAnalyticsTable({ threads = [], initialCount = 10 }) {
  ...
  return (
    <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] animate-fade-up">
      ...
      <div className="px-5 py-4 border-b border-[rgba(255,255,255,0.06)]">
        <h2 className="text-[16px] font-semibold text-[#ededed]">Posts Analytics</h2>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[rgba(255,255,255,0.06)]">
                <th className="text-left py-3 px-2 text-[11px] font-medium uppercase tracking-[0.06em] text-[rgba(255,255,255,0.4)]">Posts</th>
                <th className="text-left py-3 px-2 text-[11px] font-medium uppercase tracking-[0.06em] text-[rgba(255,255,255,0.4)]">Subreddit</th>
            ...
            <tbody>
              {visibleThreads.length === 0 ? (
                <tr><td colSpan={5} className="py-8 text-center text-[13px] text-[rgba(255,255,255,0.4)]">No Posts available.</td></tr>
              ) : (
                visibleThreads.map((thread, index) => (
                  <tr key={thread.id ?? index} className="border-b border-[rgba(255,255,255,0.04)] hover:bg-[rgba(255,255,255,0.02)] transition-colors">
        ...
        {canExpand && (
          <div className="mt-4 flex items-center justify-between">
            ...
            <button
              ...
              aria-label={showAll ? "Show less posts" : "Show all posts"}
            >
