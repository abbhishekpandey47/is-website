                            ...
                            fileMemo.map((file, index) => {
                                return (
                                    <div key={index} className='flex-shrink-0 w-auto mix-blend-color-burn'>
                                        <Image loading='lazy' width={150} height={50} className='w-40 max-sm:w-30 filter brightness-0 invert ' src={`/trustedby/${file}`} alt="Ratio is 3.9" />
                                    </div>
                                )
                            })
                        }
