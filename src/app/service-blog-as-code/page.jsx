...
const page = () => {
  ...
  <div className="max-w-7xl mx-auto flex justify-center max-md:flex-col sm:flex-col lg:flex-row items-start">
    {/* Left side content */}
    <div className="lg:w-1/2 lg:flex lg:flex-col lg:items-start z-10 mb-12 lg:mb-0">
      <h2 className="text-5xl lg:text-4xl md:text-6xl quicksand-bold text-white mb-6 leading-tight">
