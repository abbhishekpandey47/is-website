...
export default function ContentROICalculator() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 font-sans" style={{ backgroundColor: "#0d0a1a" }}>
      <div className="mt-36">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="mb-5">
                ...
                <div className="text-right text-gray-300 mt-1">{domainExpertise ? "Yes" : "0%"}</div>
              </div>
