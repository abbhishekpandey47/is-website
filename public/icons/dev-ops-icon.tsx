// icon:infinity | Typicons https://www.s-ings.com/typicons/ | Stephen Hutchings
import * as React from "react";

function IconInfinity(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      baseProfile="tiny"
      viewBox="0 0 24 24"
