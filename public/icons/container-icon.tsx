// icon:container-24 | Octicons https://primer.style/octicons/ | Github Primer
import * as React from "react";

function IconContainerTwentyFour(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconContainerTwentyFour;
