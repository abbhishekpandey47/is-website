            ...
            sections: [
                {
                    ...
                    description: "State the developer problem in practical terms and promise a concrete, observable outcome."
                },
                {
                    title: "Step execution and validation",
                    description: "Write steps with action, expected output, and a quick validation check so readers can verify progress."
                },
                {
                    title: "Examples that match real workflows",
                    description: "Use realistic values, versions, and environments so code and commands can be copied and run as-is."
                },
                {
                    title: "Handling errors, alternatives, and next steps",
                    description: "Document specific errors, offer practical alternatives, and close with production-minded next moves."
                }
            ]
        }
    },
